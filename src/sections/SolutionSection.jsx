        ...
        <section className="bg-[#F3F4F6] py-24">
            <Container className="max-w-[1160px]">
                ...
                <div className="space-y-8">
                    {/* CARD 1 */}
                    <div className="bg-white-custom rounded-2xl shadow-md lg:h-[250px] grid md:grid-cols-3 items-center lg:gap-8 lg:pr-8">
                    ...
                    {/* CARD 2 */}
                    <div className="bg-white-custom rounded-2xl shadow-md lg:h-[250px] grid md:grid-cols-3 items-center lg:gap-8 lg:pl-8">
